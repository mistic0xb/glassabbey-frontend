        ...
        <div className="flex items-center gap-4">
          {isLoading ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={logout}
                className="flex justify-center items-center gap-1 p-2 rounded-lg border border-border text-xs text-muted-foreground hover:text-destructive bg-destructive/10 transition-colors cursor-pointer"
                title="Sign Out"
              >
